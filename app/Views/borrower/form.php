        ...
        <div class="x_panel">
          <div class="x_content">
            <form action="<?= base_url($target_url) ?>" method="post" enctype="multipart/form-data">
              ...
              <div class=" field item form-group">
                <label class="col-form-label col-md-3 col-sm-3  label-align">Birth birth date</label>
                <div class="input-group col-md-6 col-sm-6">
              ...
              <div class=" field item form-group">
                ...
                <div class="input-group col-md-6 col-sm-6">
                  <input type="text" name="address" class="form-control <?= (!empty(session()->getFlashdata('validation')['address'])) ? 'is-invalid' : '' ?>" placeholder="" value="<?= ($is_edit) ? '' : old('address') ?>">
                  <div class="invalid-feedback">
              ...
              <div class=" field item form-group">
                ...
                <div class="input-group col-md-6 col-sm-6">
                  <input type="text" name="gender" class="form-control <?= (!empty(session()->getFlashdata('validation')['gender'])) ? 'is-invalid' : '' ?>" placeholder="" value="<?= ($is_edit) ? '' : old('gender') ?>">
                  <div class="invalid-feedback">
              ...
              <div class=" field item form-group">
                ...
                <div class="input-group col-md-6 col-sm-6">
                  <input type="num" name="contact" class="form-control <?= (!empty(session()->getFlashdata('validation')['contact'])) ? 'is-invalid' : '' ?>" placeholder="" value="<?= ($is_edit) ? '' : old('contact') ?>">
                  <div class="invalid-feedback">
              ...
              <div class=" field item form-group">
                ...
                <div class="input-group col-md-6 col-sm-6">
                  <input type="email" name="email" class="form-control <?= (!empty(session()->getFlashdata('validation')['email'])) ? 'is-invalid' : '' ?>" placeholder="" value="<?= ($is_edit) ? '' : old('email') ?>">
                  <div class="invalid-feedback">
              ...
              <a type="button" class="btn btn-danger" href="<?= base_url('/borrower') ?>">Back</a>
            </form>
